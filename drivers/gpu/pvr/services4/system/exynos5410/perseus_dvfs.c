...
/* level, clock, voltage, src clk, min, max, qmin, qmax, stay, mask, etc */
	{ 0,    700, 1250000,     700, 234, 256,   226, 256, 1, 0, 0 },
	{ 1,    640, 1225000,     640, 228, 244,   221, 250, 1, 0, 0 },
	{ 2,    600, 1200000,     600, 216, 244,   210, 250, 1, 0, 0 },
	{ 3,    532, 1150000,     532, 220, 244,   195, 250, 1, 0, 0 },
	{ 4,    480, 1100000,     480, 177, 244,   160, 250, 2, 0, 0 },
	{ 5,    350,  925000,     350, 185, 244,   158, 250, 3, 0, 0 },
	{ 6,    266,  900000,     266, 162, 244,    83, 250, 3, 0, 0 },
	{ 7,    177,  900000,     177,   0, 244,     0, 250, 3, 0, 0 },
};
